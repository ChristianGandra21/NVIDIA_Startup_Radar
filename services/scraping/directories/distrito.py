"""
Ingestão do Distrito Blog.
https://www.distrito.me/blog/

Estratégia: fetch_static + trafilatura + LLM Extractor.
Artigos técnicos e específicos sobre IA no Brasil.
"""
...
DISTRITO_BLOG_URL = "https://www.distrito.me/blog/"
EXTRACTION_METHOD = "trafilatura+llm_distrito"
...
def list_article_urls(index_html: str) -> list[str]:
    """Extrai URLs de artigos da página inicial do blog."""
    ...
    for a in soup.find_all("a", href=True):
        ...
        if href.startswith("/blog/") and href != "/blog/":
            urls.add(f"https://www.distrito.me{href}")
    return sorted(urls)
